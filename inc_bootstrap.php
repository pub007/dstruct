...
/**
 * Encodes HTML special characters safely for UTF-8. Use instead of htmlspecialchars.
 *
 * @param string $var
 * @return string
 */
function html_specialchars($var)
{
 ...
 *
 *<code>echo 'posted var:' . checkset($_POST['var']);</code>
 *
 *@param string &$var
 *@param mixed $default Returns this if the $var param is !isset()
 *@return string
 */
function checkset(&$var, $default = '')
{
